...
| FUSE_FMC_KEY_MANIFEST_SVN       | 32           | FMC Security Version Number (Deprecated)                |
...
| Image SVN | 4 | Security Version Number for the image. This field is present for backwards compatibility and must be equal between FMC and RT FW images. It is compared to FW SVN fuses. |
